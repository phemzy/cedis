...
class TransactionReset extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->line('The status of your matched transaction to sell ' . $this->transaction->package->amount . ' cedis worth of ' . $this->transaction->market->abbr_name . ' has been reset to pending since the matched user has refused to pay.')
