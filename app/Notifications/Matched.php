...
class Matched extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->line('Your current transaction request to ' . $this->t->type . ' &#8373;' . number_format($this->t->package->amount, 2) . ' worth of ' . $this->t->market->abbr_name . ' on Crypto2Cedis has been matched.')
