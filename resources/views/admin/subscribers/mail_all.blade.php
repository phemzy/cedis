    ...
    <div class="content content-boxed">
        <div class="block block-bordered">
            ...
            <div class="block-content">
                <form class="form-horizontal push-10-t push-10" action="{{ route('subscriber.mail.send') }}" method="post">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-sm-7">
                            <div class="form-group">
                                <div class="col-xs-6">
                                    ...
                                    <input class="form-control input-lg" type="text" id="mega-firstname" name="email" value="@crypto2cedis.com">
                                </div>
                                <div class="col-xs-6">
