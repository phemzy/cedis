                        ...
                        <div class="block-content">
                            ...
                            <div class="list-group">
                                ...
                                <a class="list-group-item" href="javascript:void(0)">
                                    ...
                                    <i class="fa fa-fw fa-send push-5-r"></i> Cedis Value
                                </a>
                                <a class="list-group-item" href="javascript:void(0)">
	                ...
	                <div class="block block-themed">
	                    ...
	                    <div class="block-content">
	                        <div class="text-center push-10-t push-30">
	                            <img class="img-avatar img-avatar96" src="{{ $t->recipient() ? Storage::url($t->recipient()->profile->profile_pic) : asset('assets/img/avatars/avatar10.jpg') }}" alt="">
	                        </div>
	                        <div class="row">
											...
											<div class="form-group">
				                                <div class="col-xs-12">
				                                	@if($t->matched_transaction->proof_of_payment == NULL)
				                                    	<button class="btn btn-sm btn-primary" disabled="" type="button"><i class="fa fa-lock push-5-r"></i> {{ $t->recipient()->fullname() }} has not uploaded proof</button>
				                                    @else
	                    ...
	                    <div class="block-content" style="padding-bottom: 50px;">
	                    	<div class="row text-center">
	                    		...
	                    		<div class="col-xs-4"><a href="{{ route('market.buy', $t->market->abbr_name) }}" class="btn btn-rounded btn-success">Market</a></div>	                    		
	                    	</div>	
	                    </div>
	                </div>
	                <!-- END Material Lock -->
