...
<body id="top">
   <div id="fb-root"></div>
        ...
        <section class="navigation">
            <header>
                <div class="header-content">
                    <div class="logo"><a href="#"><img src="img/image.jpg" alt="Sedna logo"></a></div>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="hero-content text-center">
                        <h1>Buy, Sell, Grow!</h1>
                        <p class="intro">Introducing <b>“Crypto To Cedis</b>. A platform for buying and selling of cryptocurrencies in <b>CEDIS</b>.</p>
            ...
            <div class="row">
                <div class="col-md-5 col-md-offset-7">
                    <div class="feature-list">
                        <h3 id="about-crypto2naira">About Crypto To Cedis</h3>
                        <p>
                            Crypto To Cedis is a platform dedicated specifically towards the conversion of cryptocurrencies to the Ghanaian 'cedis'. It achieves that through a recurrent mutual obligation between registered members.
                        </p>
    ...
    <section class="features-extra section-padding" id="cryptos">
        ...
        <div class="responsive-feature-img"><img src="img/logo_big.png" alt="responsive devices"></div>
    </section>
                    ...
                    <div class="flexslider">
                        <ul class="slides">
                            <li>
                                ...
                                <h2>"Never knew how rich I was until I found out Crypto2Cedis existed"</h2>
                            ...
                            <li>
                                ...
                                <h2>"Wish I had found out about Crypto2Cedis earlier; What an amazing service."</h2>
    ...
    <section class="sign-up section-padding text-center" id="get-started">
        <div class="container">
			...
			<br><br> -->
                <div class="col-md-6 col-md-offset-3">
                    <h3>Get started with Crypto To Cedis, absolutely free</h3>
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="footer-links">
                        ...
                        <p>Copyright © 2017 <a href="/">CrypToCedis</a><br>
                    </div>
                </div>
                <div class="social-share">
                    <p>Share CrypToCedis with your friends</p>
                    <div class="fb-share-button" data-href="https://crypto2cedis.com" data-layout="button" data-size="large" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fcrypto2cedis.com%2F&amp;src=sdkpreparse">Share</a></div>
                </div>
            </div>
        </div>
    </footer>
